...
//int v=Integer.parseInt(value);
   ...
   //Query
   //String  querystmt2 = "select *  from books where book_name  ="+v+"";
    ...
    String sqlPagination="SELECT SQL_CALC_FOUND_ROWS * FROM books  where book_name LIKE  '%value%'  limit  "+iPageNo+","+iShowRows+"";
...
<table width="923" border="1" align="center" cellpadding="0" cellspacing="0" id="1" valign="top">
  <tr valign="top">
    <td width="919" height="1062" ><table width="911" height="1034" border="1" id="2">
      <tr valign="top">
      ...
      <tr valign="top">
        <td height="843"><table width="904" height="826" border="1" id="3">
          <tr valign="top">
