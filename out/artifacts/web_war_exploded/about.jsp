...
<title>Web Book Store - About Us</title>
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <img src="images/about.gif" alt="" title="" class="right" /> 
             WBS is an online web application where the customer can purchase books  online. Through a web browser the customers can search for a book by its title  or author, later can add to the shopping cart and finally purchase through  different modes of payment. The user can login using his account details or new  customers can set up an account. They should give the details of their name,  contact number and shipping address. The user can also give feedback to a book  by giving ratings on a score of five. The books are divided into many  categories based on subject like Software, Database, Languages, Architecture,  etc.</p>
