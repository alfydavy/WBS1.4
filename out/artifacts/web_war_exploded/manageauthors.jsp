...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Enter Author</div>
        
        	<div class="feat_prod_box_details">
            <p class="details">Enter the name of the author here:</p>
            <p class="details">&nbsp; </p>
            <div class="contact_form">
              <div class="form_subtitle">enter all the details</div>
                 <form id="register" name="register" method="post" action="response.jsp">          
                    ...
                    <div class="form_row">
                    <label class="contact"><strong>Author Name:</strong></label>
