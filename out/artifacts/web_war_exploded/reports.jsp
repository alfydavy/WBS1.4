...
%>welcome <%=user.toUpperCase()%></a></li>
       ...
       <div class="center_content">
       	<div class="left_content">
       	  <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Reports</div>
            
          <div class="feat_prod_box">
        	  <div class="clear">
        	    <ul class="list">
        	      <li><a href="bookreports.jsp">Books Available</a></li>
        	      <li><a href="userreports.jsp"> Users </a></li>
