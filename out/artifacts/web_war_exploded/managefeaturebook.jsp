...
<title>Enter Featured Books</title>
...
<div id="wrap">
       ...
       <div class="header">
        ...
        <div id="menu">
            ...
            <li class="selected"><a href="managefeaturebook.jsp">featured books</a></li>
       ...
       <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Enter Featured Books</div>
        
        	<div class="feat_prod_box_details">
            <p class="details">Enter the featured book  here:</p>
            <p class="details">&nbsp; </p>
            <div class="contact_form">
              <div class="form_subtitle">enter all the details</div>
                 <form id="register" name="register" method="post" action="addfeaturedbooks.jsp">          
                    <div class="form_row">
                    <label class="contact"><strong>ID:</strong></label>
                    <input type="text" name="featuredid" class="contact_input" />
                    </div>  


                    <div class="form_row">
                    <label class="contact"><strong>Book ID:</strong></label>
                    <input type="text" name="bookid" class="contact_input" />
                    </div> 
        ...
        <div class="right_content">
                ...
                <ul class="list">
                  ...
                  <li><a href="managefeaturebook.jsp">Add Category</a></li>
