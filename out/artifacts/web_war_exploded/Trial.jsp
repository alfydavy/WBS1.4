...
ResultSet rs=null;
 ...
 rs=st.executeQuery("SELECT * FROM books limit  10");
 while(rs.next()){
  %>
                ...
                <div class="prod_det_box">
                    ...
                    <a href="#" class="more"><img src="images/addtocart.gif" alt="" title="" border="0" /></a>
                    <div class="clear"></div>
                    </div>
              ...
              <table width="188" border="1" id="3-1-1">
                  <tr>
                    ...
                    <div class="new_prod_box">
                        <a href="Trial.jsp"><%= rs.getString("book_name")%></a>
                        <div class="new_prod_bg">
                        <span class="new_icon"><img src="images/promo_icon.gif" alt="" title="" /></span>
                        <a href="Trial.jsp"><img src="<%= rs.getString("book_img")%>" alt="" title="" class="thumb" border="0" /></a>
                        </div>           
                    </div>
