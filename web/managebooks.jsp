...
<div id="wrap">
       ...
       <div class="header">
        ...
        <div id="menu">
            ...
            <li class="selected"><a href="managebooks.jsp">books</a></li>
       	...
       	<div class="left_content">
            ...
            <div class="contact_form">
              <div class="form_subtitle">enter all the details</div>
                 <form id="register" name="register" method="post" action="entrybooks.jsp">          
                    <div class="form_row">
                    ...
                    <input type="text" name="bookname" class="contact_input" />
                    </div> 
                    ...
                    <div class="form_row">
                    <label class="contact"><strong>Author ID:</strong></label>
                    <input type="text" name="authorid" class="contact_input" />
                    </div> 
