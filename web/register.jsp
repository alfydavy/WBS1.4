...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <p class="details">
             If you are new to this site, you may register with us. Please enter all the information below.</p>
            <p class="details">&nbsp; </p>
        ...
        <div class="right_content">
              ...
              <div class="cart">
                 ...
                 <span class="red"></span>
                  ...
                  <a href="javascript:window.alert('Please register and then login');" class="view_cart">view cart</a>
