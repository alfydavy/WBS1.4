...
<div id="wrap">
       ...
       <div class="header">
        ...
        <div id="menu">
            ...
            <li class="selected"><a href="managecategory.jsp">categories</a></li>
       ...
       <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Enter Category</div>
        
        	<div class="feat_prod_box_details">
            <p class="details">Enter the category of the books here:</p>
            <p class="details">&nbsp; </p>
            <div class="contact_form">
              <div class="form_subtitle">enter all the details</div>
                 <form id="register" name="register" method="post" action="addcategory.jsp">          
                    <div class="form_row">
                    <label class="contact"><strong>Category  ID:</strong></label>
                    <input type="text" name="categoryid" class="contact_input" />
                    </div>  


                    <div class="form_row">
                    <label class="contact"><strong>Category  Name:</strong></label>
                    <input type="text" name="categoryname" class="contact_input" />
                    </div>
                    <div class="form_row">
                    </div> 
